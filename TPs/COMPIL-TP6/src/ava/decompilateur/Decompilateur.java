...
public class Decompilateur implements Visiteur {
	...
	this.repTextuelle = this.repTextuelle + "-- texte produit par décompilation\n";
	// entête
     ...
     */
    private void decompilationExpressionDansImpression(Expression expr) 
	                          throws VisiteurException {
	expr.visite(this);
	this.repTextuelle = this.repTextuelle + ");";		
    }
	...
	if (i == null)
	    throw new DecompilateurException();
	this.repTextuelle = this.repTextuelle + "\n" + "write(%i,";
	this.decompilationExpressionDansImpression(i.getExpr());
    }
