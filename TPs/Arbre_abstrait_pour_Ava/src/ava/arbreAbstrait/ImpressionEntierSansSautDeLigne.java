...
/** Impression d'un entier dans un programme Ava.
 * @author M. Nebut
 * @version 11/07
 */
public class ImpressionEntierSansSautDeLigne implements ImpressionSansSautDeLigne {
     ...
     */
    public ImpressionEntierSansSautDeLigne(Expression e) {
	if (e == null)
	...
	if (v == null)
	    throw new IllegalArgumentException();	
	v.visiteImpressionEntierSansSautDeLigne(this);
    }
