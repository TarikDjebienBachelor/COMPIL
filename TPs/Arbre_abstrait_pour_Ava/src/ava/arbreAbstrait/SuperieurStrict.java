...
/** Opérateur sup strict dans un programme Ava.
 * @author M. Nebut
 * @version 11/07
 */
public class SuperieurStrict extends Comparaison {
     ...
     * valent null.
     */
    public SuperieurStrict(Expression g, Expression d) {
	super(g,d);
    }
